...
// import { createThirdwebClient } from "thirdweb"; // Tidak perlu jika hanya pakai clientId string
// import { defineChain } from "thirdweb/chains"; // Hapus jika tidak dipakai
...
const FarcasterConnectMenu = () => {
  ...
  const buyUrl = `https://embed.thirdweb.com/buy?clientId=${CLIENT_ID}&projectId=${THIRDWEB_PROJECT_ID}&chainId=${CHAIN_ID}&tokenAddress=${TOKEN_ADDRESS}&amount=0.002&seller=${SELLER}&currency=USD&theme=dark&primaryColor=%2300ff00`;
        ...
        <Card className="p-3 bg-[#222] border-[#444]">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant="outline"
                className="bg-[#111] text-green-400 border-[#333]"
              >
                Connected
              </Badge>
            </div>
      ...
      <Card className="p-3 bg-[#222] border-[#444]">
        <div className="space-y-3">
          ...
          <p className="text-xs text-gray-400 text-center">
            Connect your Base wallet to earn rewards and
